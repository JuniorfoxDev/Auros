  ...
  return (
    <div className='h-auto px-3 md:px-28 py-14'>
        ...
        {products.slice(0,7).map(()=> {
            ...
            <img src={products.images[0].url} alt="" className='rounded-lg w-[400px] h-[400px]'/>
            <div className='p-2 md:p-4 text-black/[0.9]'>
              <h2 className='text-sm md:text-base font-semibold'>{products.name}</h2>
              <div className='flex items-center text-black/[0.5]'>
              <p className='mr-2 text-lg font-bold'>&#8377; {products.price}</p>
