  ...
  return (
    <div className=' h-auto md:h-[500px] text-white bg-black flex justify-between px-8 md:px-28 py-12 gap-2 '>
      <div className='lf'>
        ...
        <h4 className='md:w-[400px] w-auto md:py-4'><span className='font-bold text-sm md:text-xl'>A Request - </span>In case we are unable to pickup your call for any reason, please dont panic. Our team will call you back within 24 working hrs. You can also contact us via this form or whatsapp us on the above number.</h4>
        </div>
        <div>
